var imageDecryption = function(__src){
...
function __kernel_D(index, _sData, _width, _pos_xy, _wl, _A, _pi)
{	
	var _x = index[1];
	var _y = index[0];
...
var imageDecryption_p = function(__src){
	var sData = __src.data,
		width = __src.width,
		height = __src.height,
		pi = Math.PI;
	...
	var dData = new ParallelArray([height, width], __kernel_D, tmpArray, width, pos_xy, wl, A, pi).data;
	return dData;
};